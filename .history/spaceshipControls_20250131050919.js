export class SpaceshipControls {
    constructor(camera) {
        ...
        this.maxUpSpeed = 1000;  // Limit for upward movement speed
        this.minDownSpeed = -1000;  // Limit for downward movement speed

        // Limits for the camera's vertical position
        this.minY = -500;  // Minimum vertical position for the camera
        this.maxY = 500;   // Maximum vertical position for the camera
    ...
    updateMovement() {
        ...
        if (this.spaceshipMode) {
            ...
            // Clamp the camera's vertical position (y-axis) within the limits
