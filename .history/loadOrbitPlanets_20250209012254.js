...
export function loadOrbitPlanets(scene, camera, renderer) {
  ...
  // This new controls instance is separate from any controls created elsewhere.
  if (orbitControls) {
  ...
  orbitControls.minDistance = 100;    // Allow closer zooming
  orbitControls.maxDistance = 10000;  // Allow farther zooming if needed
