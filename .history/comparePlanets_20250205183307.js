...
function performComparisonLayout(scene, camera, controls) {
  ...
  // Ensure camera and controls are initialized
  if (!camera || !controls) {
    console.error("Camera or controls are not initialized.");
    return;
  }
  ...
  if (controls && controls.target) {
    ...
    console.error("Controls or controls.target is not defined.");
  }
