...
camera.position.set(0, 800, 2000);  // Adjust as needed
camera.lookAt(0, 0, 0);
if (controls) {
  controls.target.set(0, 0, 0);
  
  // Update the zoom limits for Orbit Mode
  controls.minDistance = 100;   // Closer minimum distance
  controls.maxDistance = 10000; // Adjust the maximum distance appropriately
