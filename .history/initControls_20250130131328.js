...
export function initControls(camera, renderer, scene, planets) {
    ...
    controls.enablePan = false; // Disable pan, we'll implement our own
    ...
    // Detect drag end and stop movement
    ...
    function onMouseMove(event) {
        ...
        // Convert mouse movement into direction vectors for camera movement
    ...
    // Move the camera smoothly based on the dragging direction
    function moveToNextScene(direction) {
        const moveDistance = 5000; // Adjust how far the camera should move
    ...
    renderer.domElement.addEventListener("mousemove", onMouseMove, false);  // Track mouse movement while dragging
    renderer.domElement.addEventListener("mouseup", onMouseUp, false);
    renderer.domElement.addEventListener("mouseleave", onMouseUp, false); // Stop dragging when mouse leaves
