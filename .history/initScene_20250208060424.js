...
export function initScene() {
    ...
    // Set zoom limits:
    // - controls.minDistance: how close the camera can get to the target (zoom in limit)
    // - controls.maxDistance: how far the camera can move from the target (zoom out limit)
    controls.minDistance = 10000;   // Adjust this value as needed for your scene.
    controls.maxDistance = 50000;  // Adjust this value as needed for your scene.
