...
export function loadOrbitModeModel(scene, camera, controls) {
    ...
    orbitLoader.load(
        ...
        (gltf) => {
            ...
            // Set the camera to be far from the model.  
            // Here we place the camera above and away from the center.
            // Feel free to adjust the multipliers to get the desired view.
            const desiredDistance = modelRadius * 5;
