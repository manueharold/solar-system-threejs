...
function animateScene() {
    ...
    if (planetName === "moon") {
        moonOrbitPaused = true;  // Pause without resetting phase
    } else {
        setTimeout(() => {
            moonOrbitPaused = false;  // Resume orbit after delay
        }, 2000);
    }
}
...
export function moveToPlanet(planetName, camera, controls, scene) {
    ...
    if (lastPlanet === "moon") {
        moonOrbitPaused = true;  // Pause the Moon’s orbit
    }
    ...
    if (planetName === "moon") {
        ...
        setTimeout(() => {
            moonOrbitPaused = false;  // Resume the orbit after the delay
        }, 2000);
    }
