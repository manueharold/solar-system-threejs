...
import { loadPlanets, updatePlanets, moveToPlanet } from './loadPlanets.js';  // Notice updatePlanets import
...
// ================================
// LOAD INITIAL MODELS (Default Planets)
// ================================
loadPlanets(scene);
...
function animate() {
    ...
    // Update orbit mode animations (if any)
    updateOrbitModeAnimation(deltaTime);
    
    // Update default planets rotation and moon orbit
    updatePlanets();
