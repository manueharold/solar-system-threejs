...
export function initControls(camera, renderer) {
    ...
    controls.updateZoomLimits = function (planet) {
        ...
        // Ensure minDistance is at least half the planet's size to prevent zoom-through
        const newMinDistance = Math.max(planetSize * 0.6, planetSize * minZoomFactor);
        const newMaxDistance = planetSize * maxZoomFactor + 50000;
