...
const planetSizeMultiplier = 0.1; // Adjust this to fine-tune overall visibility

const orbitPlanetScales = {
  sun: 100, // Keep Sun size separate
  mercury: planetData.mercury.size * planetSizeMultiplier,
  venus: planetData.venus.size * planetSizeMultiplier,
  earth: planetData.earth.size * planetSizeMultiplier,
  mars: planetData.mars.size * planetSizeMultiplier,
  jupiter: planetData.jupiter.size * (planetSizeMultiplier * 0.8), // Slightly reduced
  saturn: planetData.saturn.size * (planetSizeMultiplier * 0.75),
  uranus: planetData.uranus.size * (planetSizeMultiplier * 0.6),
  neptune: planetData.neptune.size * (planetSizeMultiplier * 0.6),
};
