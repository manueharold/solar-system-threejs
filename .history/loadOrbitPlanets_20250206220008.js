...
const sunOrbitScale = 100; // Make the Sun more dominant

const orbitPlanetScales = {
  sun: sunOrbitScale,
  mercury: sunOrbitScale * (planetData.mercury.size / planetData.sun.size) * 0.05, // Slightly larger
  venus: sunOrbitScale * (planetData.venus.size / planetData.sun.size) * 0.1,
  earth: sunOrbitScale * (planetData.earth.size / planetData.sun.size) * 0.2,
  mars: sunOrbitScale * (planetData.mars.size / planetData.sun.size) * 0.3,
  jupiter: sunOrbitScale * (planetData.jupiter.size / planetData.sun.size) * 0.5, // Better balance for gas giants
  saturn: sunOrbitScale * (planetData.saturn.size / planetData.sun.size) * 0.6,
  uranus: sunOrbitScale * (planetData.uranus.size / planetData.sun.size) * 0.6,
  neptune: sunOrbitScale * (planetData.neptune.size / planetData.sun.size) * 0.6,
};
