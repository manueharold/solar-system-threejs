...
// Orbit Mode Functionality Toggle
orbitButton.addEventListener('click', () => {
    // If button text is "Orbit Mode", switch to orbit mode:
    if (orbitButton.innerText === "Orbit Mode") {
        orbitButton.innerText = "Original Mode";
        loadOrbitModeModel(scene, camera, controls);
    } else {
        // Otherwise, load the original planets model:
