...
import SimplexNoise from "https://cdn.skypack.dev/simplex-noise"; // Use default import
...
export function createProceduralPlanet(name, radius, detail, color, position, scene) {
    ...
    const noise = new SimplexNoise(); // Initialize SimplexNoise using default import
