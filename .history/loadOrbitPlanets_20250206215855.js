...
const orbitPlanetScales = {
  sun: sunOrbitScale,
  mercury: sunOrbitScale * (planetData.mercury.size / planetData.sun.size) * 3.5, // Slightly larger
  venus: sunOrbitScale * (planetData.venus.size / planetData.sun.size) * 3.2,
  earth: sunOrbitScale * (planetData.earth.size / planetData.sun.size) * 3.5,
  mars: sunOrbitScale * (planetData.mars.size / planetData.sun.size) * 3.2,
  jupiter: sunOrbitScale * (planetData.jupiter.size / planetData.sun.size) * 1.1, // Better balance for gas giants
  saturn: sunOrbitScale * (planetData.saturn.size / planetData.sun.size) * 1.0,
  uranus: sunOrbitScale * (planetData.uranus.size / planetData.sun.size) * 0.9,
  neptune: sunOrbitScale * (planetData.neptune.size / planetData.sun.size) * 0.9,
};
