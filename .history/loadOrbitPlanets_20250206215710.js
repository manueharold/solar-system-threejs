...
const sunOrbitScale = 50;
const orbitPlanetScales = {
  sun: sunOrbitScale,
  mercury: sunOrbitScale * (planetData.mercury.size / planetData.sun.size) * 2.5,
  ...
  jupiter: sunOrbitScale * (planetData.jupiter.size / planetData.sun.size) * 0.01,
  saturn: sunOrbitScale * (planetData.saturn.size / planetData.sun.size) * 0.01,
  uranus: sunOrbitScale * (planetData.uranus.size / planetData.sun.size) * 0.05,
