...
export function moveToPlanet(planetName, camera, controls, scene) {
    // Logic to move the camera to the planet (you'll have to adjust it based on your Three.js setup)
    console.log(`Moving to ${planetName}`);
    // Example: set camera position, update controls, etc.
    if (planetName === 'earth') {
      camera.position.set(0, 0, 100); // Example coordinates for Earth
      controls.update();
    }
