...
function performComparisonLayout(scene, camera, controls) {
  ...
  // Define a constant effective radius for the Sun during comparisons.
  const SUN_COMPARISON_RADIUS = 0.002;

  // Helper: If the object is the Sun, use a fixed (smaller) effective radius.
  ...
  // Use a different camera multiplier if the Sun is present,
  // so that the camera backs off further.
