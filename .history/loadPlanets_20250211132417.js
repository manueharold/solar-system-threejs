 ...
 * Temporarily hides all planets during the transition and only shows
 * the target planet when the movement is complete.
 *
...
export function moveToPlanet(planetName, camera, controls, scene, isOrbitModeActive) {
  return new Promise((resolve, reject) => {
    ...
    // Temporarily hide all planets during the transition.
    ...
    // Compute the planet's bounding sphere to frame it.
    ...
    const tl = gsap.timeline({
      onComplete: () => {
        ...
        // Show only the target planet after the movement is done.
