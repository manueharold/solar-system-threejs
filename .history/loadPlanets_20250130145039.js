...
export function loadPlanets(scene) {
    loadPlanetModel(scene, "Sun", './3d_models/sun.glb', [-80000, 0, 0], 30000);  
    loadPlanetModel(scene, "Mercury", './3d_models/mercury.glb', [-60000, 0, 0], 608);
    loadPlanetModel(scene, "Venus", './3d_models/venus.glb', [-50000, 0, 0], 1520);
    loadPlanetModel(scene, "Earth", './3d_models/earth.glb', [-40000, 0, 0], 1600);
    loadPlanetModel(scene, "Mars", './3d_models/mars.glb', [-30000, 0, 0], 848);
