...
export function showPlanetInfo(planetData) {
    ...
    const planetName = panel.querySelector('h2');
    const planetDescription = panel.querySelector('p');
    const planetImage = panel.querySelector('img');
    const closeBtn = panel.querySelector('.close-btn');

    planetName.textContent = planetData.name;
    planetDescription.textContent = planetData.description;
    planetImage.src = planetData.imageURL || '';
