...
export function setupModeToggles(scene, camera, controls) {
  ...
  spaceshipButton.addEventListener("click", () => {
    if (orbitModeActive) {
      // Show error notification if Orbit Mode is active.
  ...
  orbitButton.addEventListener("click", () => {
    if (!orbitModeActive) {
      ...
      // Optionally add a CSS class to visually indicate Spaceship Mode is disabled.
      ...
      // Remove the visual indication from the Spaceship Mode button.
