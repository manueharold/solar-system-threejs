...
export function loadPlanets(scene) {
    ...
    loadPlanetModel(scene, "Venus", './3d_models/venus.glb', [-300000, 0, 0], 9500);  // 108.2 million km from Earth
    loadPlanetModel(scene, "Mars", './3d_models/mars.glb', [227900, 0, 0], 5200);  // 227.9 million km from Earth
    loadPlanetModel(scene, "Jupiter", './3d_models/jupiter1.glb', [778500, 0, 0], 30000);  // 778.5 million km from Earth
    loadPlanetModel(scene, "Saturn", './3d_models/saturn.glb', [1433000, 0, 0], 28000);  // 1.433 billion km from Earth
    loadPlanetModel(scene, "Uranus", './3d_models/uranus.glb', [2877000, 0, 0], 16000);  // 2.877 billion km from Earth
    loadPlanetModel(scene, "Neptune", './3d_models/neptune.glb', [4503000, 0, 0], 15500);  // 4.503 billion km from Earth
