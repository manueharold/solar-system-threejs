...
const sunOrbitScale = 100;
const orbitPlanetScales = {
  sun: sunOrbitScale,
  mercury: (planetData.mercury.size / planetData.sun.size) * 2.5,
  venus:  (planetData.venus.size / planetData.sun.size) * 0.62,
  earth:  (planetData.earth.size / planetData.sun.size) * 0.7,
  mars:  (planetData.mars.size / planetData.sun.size) * 0.92,
  jupiter:  (planetData.jupiter.size / planetData.sun.size) * 10,
  saturn:  (planetData.saturn.size / planetData.sun.size) * 0.01,
  uranus:  (planetData.uranus.size / planetData.sun.size) * 0.05,
  neptune:  (planetData.neptune.size / planetData.sun.size) * 0.34,
};
