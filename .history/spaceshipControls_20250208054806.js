export class SpaceshipControls {
    ...
    onKeyChange(event, isPressed) {
        ...
        const actions = {
            ...
            " ": () => {
                if (isPressed) {
                    this.acceleration.y = Math.min(speed, this.maxUpSpeed); // Apply upward speed limit
                } else {
            ...
            "Control": () => {
                if (isPressed) {
                    this.acceleration.y = Math.max(-speed, this.minDownSpeed); // Apply downward speed limit
                } else {
                    this.acceleration.y = 0;
                }
            },
    ...
    onZoom(event) {
        ...
        // Limit zoom between minZoom and maxZoom
