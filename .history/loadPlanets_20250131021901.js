...
export function loadPlanets(scene) {
    ...
    loadPlanetModel(scene, "venus", './3d_models_compressed/venus_draco.glb', [108200 / 10, 0, 0], 9500);
    loadPlanetModel(scene, "mercury", './3d_models_compressed/mercury_draco.glb', [57910 / 10, 0, 0], 3800);
    loadPlanetModel(scene, "mars", './3d_models_compressed/mars_draco.glb', [227900 / 10, 0, 0], 5300);
    loadPlanetModel(scene, "jupiter", './3d_models_compressed/jupiter_draco.glb', [778500 / 10, 0, 0], 110000);
    loadPlanetModel(scene, "saturn", './3d_models_compressed/saturn_draco.glb', [1433500 / 10, 0, 0], 95000);
    loadPlanetModel(scene, "uranus", './3d_models_compressed/uranus_draco.glb', [2872500 / 10, 0, 0], 40000);
    loadPlanetModel(scene, "neptune", './3d_models_compressed/neptune_draco.glb', [4495100 / 10, 0, 0], 39000);
