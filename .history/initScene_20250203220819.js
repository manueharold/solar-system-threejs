...
export function initScene() {
    ...
    camera.position.set(149600000, 3000, 149600000 + 5000);  // Adjusted to a more realistic position near Earth
    camera.lookAt(new THREE.Vector3(149600000, 0, 0));  // Ensure the camera looks directly at Earth
