...
const sunOrbitScale = 20; // Increase Sun's scale for better visibility

const orbitPlanetScales = {
  sun: sunOrbitScale,
  mercury: sunOrbitScale * (planetData.mercury.size / planetData.sun.size) * 2.5,  // Slightly larger
  venus: sunOrbitScale * (planetData.venus.size / planetData.sun.size) * 2.2,
  earth: sunOrbitScale * (planetData.earth.size / planetData.sun.size) * 2.5,
  mars: sunOrbitScale * (planetData.mars.size / planetData.sun.size) * 2.2,
  jupiter: sunOrbitScale * (planetData.jupiter.size / planetData.sun.size) * 0.8, // Reduced gas giant size
  saturn: sunOrbitScale * (planetData.saturn.size / planetData.sun.size) * 0.85,
  uranus: sunOrbitScale * (planetData.uranus.size / planetData.sun.size) * 1.2,
  neptune: sunOrbitScale * (planetData.neptune.size / planetData.sun.size) * 1.2,
};
