...
export function loadPlanets(scene) {
    ...
    loadPlanetModel(scene, "Sun", './3d_models/sun.glb', [-50000, 0, 0], 30000);  // Sun at -50 million km
    
    // Then load the other planets relative to Earth
    loadPlanetModel(scene, "Mercury", './3d_models/mercury.glb', [58000, 0, 0], 608);  // 58 million km from Earth
    loadPlanetModel(scene, "Venus", './3d_models/venus.glb', [108200, 0, 0], 1520);  // 108.2 million km from Earth
