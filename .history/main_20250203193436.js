...
// Close the search panel (you can add a close button or any condition to hide it)
function closeSearchPanel() {
  searchPanel.classList.remove('visible'); // Remove the animation class
  setTimeout(() => {
    searchPanel.style.display = 'none'; // Hide the panel after animation
  }, 300); // Wait for the animation to finish before hiding
}

// Example of attaching a close event (you can add a close button inside the panel)
searchPanel.addEventListener('click', closeSearchPanel);
