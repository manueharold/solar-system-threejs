...
export default function PlanetInfo() {
    ...
    function showPlanetInfo(planetName) {
        setSelectedPlanet(planetData[planetName.toLowerCase()]);
    }
            ...
            <div className="hud-buttons">
                {Object.keys(planetData).map((planet) => (
                    <button
                        ...
                        className="hud-button space-theme"
                    >
    ...
    return (
        <div className="planet-info active space-theme">
            <button onClick={hidePlanetInfo} className="close-btn">✖</button>
            <h2>{selectedPlanet.name}</h2>
            <p><strong>Fact:</strong> {selectedPlanet.fact}</p>
