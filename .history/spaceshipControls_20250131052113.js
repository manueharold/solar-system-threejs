export class SpaceshipControls {
    constructor(camera) {
        ...
        this.maxUpSpeed = 5000;  // Limit for upward movement
        this.minDownSpeed = -500;  // Limit for downward movement

          // Height limits (example values)
          this.maxHeight = 0;  // Maximum height the camera can move upwards
