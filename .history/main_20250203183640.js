...
// Replace the old skybox module with our new galaxy background module.
import { initGalaxyBackground } from './initGalaxyBackground.js';
...
// 🔆 Setup Lights and Galaxy Background
initLights(scene);
initGalaxyBackground(scene);
