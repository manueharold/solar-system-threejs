...
export function moveToPlanet(planetName, camera, controls) {
    ...
    .onStart(() => {
        console.log("🚀 Animation Started: Moving Camera");
        camera.position.set(targetPosition[0], targetPosition[1], targetPosition[2] + 3000);
    })
    .start();
...
export function createSearchButton(scene, camera, controls) {
    ...
    searchButton.addEventListener("click", () => {
        ...
        moveToPlanet(planetName, camera, controls);  // ✅ Pass controls
    });
}
