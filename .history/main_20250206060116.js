...
function animate() {
  ...
  if (orbitModeActive) {
    ...
    scene.traverse((object) => {
      if (object.isMesh && ["mercury", "venus", "earth", "mars", "jupiter", "saturn", "uranus", "neptune", "moon", "sun"].includes(object.name.toLowerCase())) {
        object.rotation.y += 0.001; // Rotate all planet models
