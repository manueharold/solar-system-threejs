...
export function setupSearchFunctionality(scene, camera, controls) {
  ...
  const selectPlanet = (planet) => {
    ...
    // Move to the planet. We assume that moveToPlanet returns a Promise
    // or a GSAP tween that supports an onComplete callback.
    moveToPlanet(planetName, camera, controls, scene)
      .then(() => {
        // Resume the orbit animation once the camera move is complete
