...
// Hide the search panel after the search is complete
...
document.body.addEventListener('click', (e) => {
  if (!searchPanel.contains(e.target)) { // If the click is outside the search panel
    completeSearch(); // Hide the search panel
  }
});

// Optional: Hide the panel after search is complete by pressing enter
searchInput.addEventListener('keypress', (e) => {
  if (e.key === 'Enter') {
    completeSearch(); // Hide the search panel after pressing enter
  }
});
