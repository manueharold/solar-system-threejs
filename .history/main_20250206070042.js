...
import { loadPlanets, setOrbitMode } from './loadPlanets.js';
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // Update the local orbitModeActive flag if needed...
  orbitModeActive = isActive;
  // Tell loadPlanets.js to start/stop updating planetary orbits.
  setOrbitMode(isActive);
});
...
/**
 * Sets whether the planets should orbit the Sun.
 * @param {boolean} isActive - True to enable orbit mode; false to disable.
 */
