...
export async function loadDefaultPlanets(scene, camera, controls) {
  ...
  // --- Assign Realistic Rotation Speeds ---
  // Using the same logic as in your animation module, assign each planet its rotation speed.
  // (For example, in your other module you use:
  //    simulationEarthRotationSpeed = 2 * Math.PI / 3600; and then define rotationSpeeds accordingly.)
  // Here we iterate over the keys in the imported rotationSpeeds object:
