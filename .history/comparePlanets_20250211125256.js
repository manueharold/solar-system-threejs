...
function getPlanetInstance(name) {
  ...
  // For the Sun and Earth, reuse the original instance so the texture stays unchanged.
  if (lowerName === "sun" || lowerName === "earth") {
    // (For the Sun, you’re already scaling it once)
    return template;
  } else {
    // For all other planets, create a deep clone.
