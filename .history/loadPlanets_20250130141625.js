...
// 🎯 Move camera to a planet & hide others
...
export function createSearchButton(scene, camera, controls) {
    ...
    searchButton.addEventListener("click", () => {
        const planetName = input.value.trim().toLowerCase();
        if (planetName === "reset") {
            resetView(scene);
        } else {
