...
import { switchToOrbitScene } from './switchToOrbitScene.js'; // Import the function here
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const button = document.getElementById("orbitSceneButton");
    button.addEventListener("click", () => {
        switchToOrbitScene(scene, camera, renderer); // Call the imported function
    });
