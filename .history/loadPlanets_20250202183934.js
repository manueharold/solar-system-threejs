...
import { showPlanetInfo, hidePlanetInfo } from './planetInfo.js';
  ...
  const planetData = {
    // Scale down distances by 1,000,000x
  sun: { size: 696340, distance: 0, scale: 10 },
  mercury: { size: 4879, distance: 4, scale: 0.5 },
  venus: { size: 12104, distance: 6, scale: 1 },
  earth: { size: 12742, distance: 10, scale: 1 },
  mars: { size: 6779, distance: 15, scale: 1 },
  jupiter: { size: 139820, distance: 25, scale: 1.5 },
  saturn: { size: 116460, distance: 35, scale: 1.5 },
  uranus: { size: 50724, distance: 45, scale: 1.2 },
  neptune: { size: 49244, distance: 55, scale: 1.2 },
  moon: { size: 3474, distance: 0.04, scale: 0.2 },  // Adjusted Moon distance
  };
