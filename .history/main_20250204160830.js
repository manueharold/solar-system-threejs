...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // (Optional) Get reference to the compare panel (duplicate IDs in HTML may cause issues)
  ...
  // Function to show notification (uses green for success and red for error)
