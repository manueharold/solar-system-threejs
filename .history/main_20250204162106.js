...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // Attach click event listener to the compare button (inside the compare panel)
  compareButton.addEventListener('click', () => {
    ...
    // First, restore the visibility of all planet meshes in case one was hidden previously
    showAllPlanets(scene);

    // Now, hide all planets except for the two being compared.
    // Ensure that the planet names are converted to lowercase for matching.
